...
"write Header"
$port.WriteLine("d11 0 1 2"); Start-Sleep -Milliseconds $SERIALDELAY; $port.ReadExisting(); Start-Sleep -Milliseconds $SERIALDELAY
$port.WriteLine("d11 1 1 1"); Start-Sleep -Milliseconds $SERIALDELAY; $port.ReadExisting(); Start-Sleep -Milliseconds $SERIALDELAY
$port.WriteLine("d11 2 5 Marker m2"); Start-Sleep -Milliseconds $SERIALDELAY; $port.ReadExisting(); Start-Sleep -Milliseconds $SERIALDELAY
