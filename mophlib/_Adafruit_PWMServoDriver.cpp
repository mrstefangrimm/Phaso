/*************************************************** 
  ...
  Modified 2018 by Stefan Grimm, added the two methods setPWMOn() and setPWMOff()
 ****************************************************/
...
void Adafruit_PWMServoDriver::setPWMOn() {
  write8(ALLLED_ON_H, 0x10);
}

void Adafruit_PWMServoDriver::setPWMOff() {
  write8(ALLLED_OFF_H, 0x10);
}
